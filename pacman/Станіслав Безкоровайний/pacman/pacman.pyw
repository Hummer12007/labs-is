    ...
    def PrintMap (self):
        ...
        for row in range(0, self.lvlHeight, 1):
            ...
            for col in range(0, self.lvlWidth, 1):
                ...
                # if self.GetMapTile(row, col) >= 100:
                #     outputLine += '#'
                # else:
                #     outputLine += '.'
...
def CheckInputs(): 
    ...
    if thisGame.mode == 1:
        next_move = player_controller.next_move(thisLevel, player, ghosts, tileID, thisGame)
...
"""
        ...
        next_move = player_controller.next_move([], [], [])
